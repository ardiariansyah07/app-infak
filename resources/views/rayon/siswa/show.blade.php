...
@section('title','Detail Siswa Rayon')
...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Riwayat tagihan, bulan belum lunas, dan pembayaran siswa binaan.</p>
    </div>
    <a href="{{ route('rayon.siswa.index') }}" class="btn btn-light border">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr><th>Periode</th><th>Tahun Ajaran</th><th>Rombel</th><th>Rayon</th><th>Nominal</th><th>Terbayar</th><th>Sisa</th><th>Status</th></tr>
                </thead>
                <tbody>
                @forelse($tagihan as $item)
                    <tr>
                        ...
                        <td>{{ $item->siswaAkademik?->rayon?->nama ?? '-' }}</td>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                @forelse($riwayat as $pembayaran)
                    <tr>
                        ...
                        <td>
                            @forelse($pembayaran->alokasiPembayaran as $alokasi)
                                <div class="small">
